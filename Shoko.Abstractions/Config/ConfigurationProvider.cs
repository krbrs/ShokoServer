...
public class ConfigurationProvider<TConfig> : IDisposable where TConfig : class, IConfiguration, new()
{
    ...
    /// </returns>
    public ConfigurationActionResult PerformCustomAction(string path, string actionID, IUser? user = null, Uri? uri = null)
        => _service.PerformCustomAction(Load(), path, actionID, user, uri);
    ...
    ///   The result of the action.
    /// </returns>
    public ConfigurationActionResult PerformCustomAction(TConfig config, string path, string actionID, IUser? user = null, Uri? uri = null)
        => _service.PerformCustomAction(config, path, actionID, user, uri);
    ...
    ///   The result of the action.
    /// </returns>
    public ConfigurationActionResult PerformReactiveAction(string path, ConfigurationActionType actionType, ReactiveEventType reactiveEventType = ReactiveEventType.All, IUser? user = null, Uri? uri = null)
        => _service.PerformReactiveAction(Load(), path, actionType, reactiveEventType, user, uri);
    ...
    ///   The result of the action.
    /// </returns>
    public ConfigurationActionResult PerformReactiveAction(TConfig config, string path, ConfigurationActionType actionType, ReactiveEventType reactiveEventType = ReactiveEventType.All, IUser? user = null, Uri? uri = null)
        => _service.PerformReactiveAction(config, path, actionType, reactiveEventType, user, uri);
