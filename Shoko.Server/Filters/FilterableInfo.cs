...
public class Filterable : IFilterableInfo
{
    ...
    private readonly Lazy<IReadOnlyDictionary<CastRoleType, IReadOnlySet<string>>> _characterAppearances;
    ...
    private readonly Lazy<IReadOnlySet<string>> _releaseProviderNames;
    ...
    public IReadOnlySet<(int year, YearlySeason season)> Seasons => _seasons.Value;

    public required Func<IReadOnlySet<(int year, YearlySeason season)>> SeasonsDelegate
    {
        init => _seasons = new Lazy<IReadOnlySet<(int year, YearlySeason season)>>(value);
    }
    ...
    public IReadOnlyDictionary<CastRoleType, IReadOnlySet<string>> CharacterAppearances => _characterAppearances.Value;

    public required Func<IReadOnlyDictionary<CastRoleType, IReadOnlySet<string>>> CharacterAppearancesDelegate
    {
        init => _characterAppearances = new Lazy<IReadOnlyDictionary<CastRoleType, IReadOnlySet<string>>>(value);
    }
    ...
    public IReadOnlyDictionary<CrewRoleType, IReadOnlySet<string>> CreatorRoles => _creatorRoles.Value;

    public required Func<IReadOnlyDictionary<CrewRoleType, IReadOnlySet<string>>> CreatorRolesDelegate
    {
        init => _creatorRoles = new Lazy<IReadOnlyDictionary<CrewRoleType, IReadOnlySet<string>>>(value);
    }
    ...
    public required Func<double> LowestAniDBRatingDelegate
    {
        init => _lowestAniDBRating = new Lazy<double>(value);
    }

    public double HighestAniDBRating => _highestAniDBRating.Value;

    public required Func<double> HighestAniDBRatingDelegate
    {
        init => _highestAniDBRating = new Lazy<double>(value);
    }

    public double AverageAniDBRating => _averageAniDBRating.Value;

    public required Func<double> AverageAniDBRatingDelegate
    {
        init => _averageAniDBRating = new Lazy<double>(value);
    }
    ...
    public IReadOnlySet<string> ReleaseProviderNames => _releaseProviderNames.Value;

    public required Func<IReadOnlySet<string>> ReleaseProviderNamesDelegate
    {
        init => _releaseProviderNames = new Lazy<IReadOnlySet<string>>(value);
    }
}
